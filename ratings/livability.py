...
spark = SparkSession \
    .builder \
    .appName("Feature Selection for Livability Index") \
    .getOrCreate()
...
label_cols = ['liv_index']
cols_to_keep = ['crime_sev1','crime_sev2','crime_attempted','crime_completed','violation','misdemeanor','felony','311_sev1','311_sev2','311_sev3','311_sev4','avg_cost','avg_tip','passenger_count','grade_A_count','grade_B_count','grade_C_count']
